...
### X投稿ワークフローのルール
1. **取得タイミング**: 朝7時（JST）に全アカウントから同時に取得
2. **投稿制限**: 1日最大5投稿まで
3. **対象アカウント**: ManusAI_JP, GeminiApp, claudeai, NotebookLM, OpenAI, dify_ai
4. **各アカウントから1件ずつ取得**し、その内容を元に投稿を生成

### 投稿制限の確認方法
- 本日の投稿数を確認し、5件を超える場合は投稿を中止
- parametersに "max_posts": 5 を渡すこと
